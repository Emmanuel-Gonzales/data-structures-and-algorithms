...
const typeNum = (arr) => {
  // Solution code here...
  let numArray = arr.filter(num => (typeof num) === 'number');
  return numArray;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let strArr = arr.filter(str => str.includes('and') );
  return strArr;
};
...
const oddValues = (arr) => {
  // Solution code here...
  let oddArr = arr.filter(odd => (odd % 2) !== 0);
  return oddArr;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let filteredArr = arr.filter(elem => !forbiddenValues.includes(elem));
  // filteredArr equals arr.filter( If forbiddenValues array does not include (elem), add)
  return filteredArr;
};
