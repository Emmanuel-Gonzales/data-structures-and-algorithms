...
const addPurchases = (arr) => {
  // Solution code here...
  return (arr.reduce((accumulator, item) => accumulator + item.purchasePrice, 0));
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  return (arr.reduce((accumulator, index) => (index - index) + accumulator + 1, 0));
};
...
const returnNames = (arr) => {
  // Solution code here...
  let charaName = [];
  arr.reduce((accumulator, chara) => charaName.push(chara.name), []);
  return charaName;
};
...
const reversedString = (str) => {
  ...
  strArr.reduce((accumulator, string) => arr.unshift(string), '');
  return (arr.reduce((accumulator, string) => accumulator + string, ''));
};
